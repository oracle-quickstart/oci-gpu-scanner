...
resource "helm_release" "app" {
  ...
  chart = "https://iduyx1qnmway.objectstorage.us-ashburn-1.oci.customer-oci.com/p/9YtNK1Zuk7BSethMxEkO2eMXru9-0bK3QozsGuiCRrpvwcLt-D7pL4J_ByvFdAlg/n/iduyx1qnmway/b/helm-charts/o/lens-0.1.9-0f98029.tgz"
  wait            = true
  timeout         = 1800
  atomic          = false
