...
resource "helm_release" "app" {
  ...
  chart = "https://iduyx1qnmway.objectstorage.us-ashburn-1.oci.customer-oci.com/p/Nj1Ea-sU3pIfvCKJJGEPtCFTsuoeScgObPkg2cLVqDcTzdfP3kFZAiV_owUvE-9Q/n/iduyx1qnmway/b/helm-charts/o/lens-0.1.9-c58cfa9.tgz"
  wait            = true
  timeout         = 1800
  atomic          = false
