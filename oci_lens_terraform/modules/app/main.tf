...
resource "helm_release" "app" {
  ...
  chart = "https://iduyx1qnmway.objectstorage.us-ashburn-1.oci.customer-oci.com/p/IyZofOetI_kn5C898Nj9Mb_G__BT2xheLm7OOrUEam762Q6BW85VuumfiR3innmZ/n/iduyx1qnmway/b/helm-charts/o/lens-0.1.9-c58cfa9.tgz"
  wait            = true
  timeout         = 1800
  atomic          = false
