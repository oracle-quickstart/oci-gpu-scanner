...
| ------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Control Plane | v0.0.5      | iad.ocir.io/iduyx1qnmway/corrino-lens-backend:v0.0.5                                                                                                                                                             |
...
| Helm          | v 0.1.15 | [lens-0.1.15-20260120-0942.tgz](https://oci-ai-incubations.github.io/corrino-lens-devops/lens-0.1.15-20260120-0942.tgz)                                                                                                 |
| Quickstart    | v 0.1.15 | [v0.1.15](https://github.com/oracle-quickstart/oci-gpu-scanner/releases/download/v0.1.15/oci-gpu-scanner-deploy.zip)                                                                                                                                                    |
